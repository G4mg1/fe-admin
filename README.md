...
-- Glassmorphism effect for main frame
...
menu.Position = UDim2.new(0.85, 0, 0.1, 0)
...
cmdBox.BackgroundTransparency = 0.9
cmdBox.BorderColor3 = Color3.fromRGB(255, 255, 255)
cmdBox.BorderSizePixel = 0
cmdBox.Position = UDim2.new(0.05, 0, 0.15, 0)
cmdBox.Size = UDim2.new(0.75, 0, 0.7, 0)
cmdBox.Font = Enum.Font.GothamMedium
cmdBox.PlaceholderColor3 = Color3.fromRGB(180, 200, 255)
...
-- Glass effect for command box
local cmdBoxStroke = Instance.new("UIStroke")
cmdBoxStroke.Thickness = 1.2
cmdBoxStroke.Color = Color3.fromRGB(200, 220, 255)
cmdBoxStroke.Transparency = 0.3
cmdBoxStroke.Parent = cmdBox

local cmdBoxGradient = Instance.new("UIGradient")
cmdBoxGradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(220, 240, 255))
}
cmdBoxGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.05),
    NumberSequenceKeypoint.new(1, 0.15)
}
cmdBoxGradient.Rotation = 90
cmdBoxGradient.Parent = cmdBox
...
remotepath.BackgroundTransparency = 0.85
remotepath.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
remotepath.TextTransparency = 0.2
remotepath.TextWrapped = true
remotepath.Font = Enum.Font.GothamMedium

-- Glass effect for remote path
local remoteStroke = Instance.new("UIStroke")
remoteStroke.Thickness = 1
remoteStroke.Color = Color3.fromRGB(200, 220, 255)
remoteStroke.Transparency = 0.3
remoteStroke.Parent = remotepath

local remoteGradient = Instance.new("UIGradient")
remoteGradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(220, 240, 255))
}
remoteGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.05),
    NumberSequenceKeypoint.new(1, 0.15)
}
remoteGradient.Rotation = 90
remoteGradient.Parent = remotepath
...
mobileOpen.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
mobileOpen.BackgroundTransparency = 0.8
mobileOpen.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
mobileOpen.Font = Enum.Font.GothamMedium
mobileOpen.Text = "CMD"
...
-- Glass effect for mobile button
local mobileStroke = Instance.new("UIStroke")
mobileStroke.Thickness = 1
mobileStroke.Color = Color3.fromRGB(200, 220, 255)
...
mobileGradient.Parent = mobileOpen
...
cmds.BackgroundTransparency = 0.85
cmds.BorderColor3 = Color3.fromRGB(255, 255, 255)
cmds.BorderSizePixel = 0
cmds.Position = UDim2.new(0.5, 0, 0.5, 0)
cmds.Size = UDim2.new(0.0883912593, 0, 0.287559688, 0)
cmds.Visible = false

-- Glass effect for commands frame
local cmdsStroke = Instance.new("UIStroke")
cmdsStroke.Thickness = 1.5
cmdsStroke.Color = Color3.fromRGB(255, 255, 255)
cmdsStroke.Transparency = 0.3
cmdsStroke.Parent = cmds

local cmdsGradient = Instance.new("UIGradient")
cmdsGradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
    ColorSequenceKeypoint.new(0.5, Color3.fromRGB(200, 220, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(180, 200, 255))
}
cmdsGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.1),
    NumberSequenceKeypoint.new(0.5, 0.2),
    NumberSequenceKeypoint.new(1, 0.3)
}
cmdsGradient.Rotation = 45
cmdsGradient.Parent = cmds
...
closeStroke.Color = Color3.fromRGB(200, 220, 255)
...
closeGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.05),
    NumberSequenceKeypoint.new(1, 0.15)
}
...
cmdList.BackgroundTransparency = 0.9
cmdList.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
cmdList.ScrollBarImageColor3 = Color3.fromRGB(200, 220, 255)
cmdList.ScrollBarImageTransparency = 0.3

-- Glass effect for command list
local cmdListStroke = Instance.new("UIStroke")
cmdListStroke.Thickness = 1
cmdListStroke.Color = Color3.fromRGB(200, 220, 255)
cmdListStroke.Transparency = 0.3
cmdListStroke.Parent = cmdList

local cmdListGradient = Instance.new("UIGradient")
cmdListGradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
    ColorSequenceKeypoint.new(1, Color3.fromRGB(220, 240, 255))
}
cmdListGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.05),
    NumberSequenceKeypoint.new(1, 0.15)
}
cmdListGradient.Rotation = 90
cmdListGradient.Parent = cmdList
...
template.BackgroundTransparency = 0.85
...
-- Glass effect for template
local templateStroke = Instance.new("UIStroke")
templateStroke.Thickness = 1
templateStroke.Color = Color3.fromRGB(200, 220, 255)
templateStroke.Transparency = 0.3
...
templateGradient.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0, 0.05),
    NumberSequenceKeypoint.new(0.5, 0.1),
    NumberSequenceKeypoint.new(1, 0.15)
}
templateGradient.Rotation = 45
